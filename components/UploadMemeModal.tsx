                ...
                <div className="space-y-4">
                    ...
                    >
                        {imagePreview ? (
                            ...
                            <>
                                <div className="p-6 rounded-3xl bg-zinc-900 text-zinc-600 group-hover:text-zinc-400 transition-colors">
                                    <Upload size={40} />
                                </div>
                ...
                <form onSubmit={handlePublish} className="flex flex-col gap-6">
                    <div className="space-y-2">
                        ...
                        <textarea 
                            ...
                            className="w-full bg-zinc-950 border border-zinc-800 rounded-2xl p-5 text-sm focus:border-green-500 outline-none transition-all font-bold h-32 resize-none"
                        />
                    </div>
